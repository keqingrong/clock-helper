...
const queryStartupCommand = 'last -x reboot';
const querryShutdownCommand = 'last -x shutdown';
 ...
 * @returns {Date[]}
 */
async function getLinuxStartupDateList() {
 ...
 * @returns {Date[]}
 */
async function getLinuxShutdownDateList() {
